...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('task_tracker', '0006_alter_task_status'),
    ...
    operations = [
        migrations.AlterField(
            model_name='comment',
            name='task',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='comments', to='task_tracker.task'),
        ),
        migrations.AlterField(
            model_name='comment',
            name='user',
